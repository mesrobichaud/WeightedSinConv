...
# unet with parameterized kernel size for sinconv 
...
# unet with parameterized kernel size for sinconv + attention
...
# UNet with attention gated output 
...
class out_mod(nn.Module):
    ...
    def __init__(self, in_ch, out_ch,conv_op=nn.Conv2d):
        ...
        self.attention = nn.Sequential(conv_op(in_ch,out_ch,3,1,1),
                                     nn.Sigmoid())
        self.outc2 =conv_op(in_ch,out_ch,3,1,1) # 12D output
