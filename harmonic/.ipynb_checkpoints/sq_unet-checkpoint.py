...
from harmonic import SquareConv 
...
class ups(nn.Module):
    def __init__(self, in_ch, out_ch, sins):
        ...
        self.sinconv = SquareConv(in_ch, out_ch, sins=sins, kernel_size=7, padding=3)
...
class outconv(nn.Module):
    def __init__(self, in_ch, out_ch, sins):
        ...
        self.sinconv = SquareConv(in_ch, in_ch, sins=sins, kernel_size=7, padding=3)
